...
## Research Interests
- Robotic Person-Following, Robot Localization, 
- Spatial AI, Machine Learning, Computer Vision and Their Applications
...
- **Jiyong Oh**, Joon-Goo Lee, Hea-Min Lee, Seung-Woo Nam, Man-Soo Shin, and Sangjoon Choi, "A Person-Following Robot Using Siamese Network-Based RGBD Tracking," [21th International Conference on Control, Automation and Systems (ICCAS 2021)](http://2021.iccas.org/?page_id=962&uid=18&mod=document), Jeju, Korea, Oct. 12-15, 2021 (Work in Progress).
...
- 류수빈, 이준구, 이종택, **오지용**, "협소 환경에서 차륜형 로봇의 고속 주행 성능 향상을 위한 단일 정책 PPO 기반 안전 내비게이션", 2026 제41회 제어로봇시스템학회 학술대회 (ICROS 2026), 2026. 7. 3 (1-4).
- 이준구, 정유수, **오지용**, 이종택, "추종 로봇을 위한 2D LiDAR 기반 사용자 추적 방법", 2026년도 한국통신학회 하계종합학술발표회, 2026. 6. 17 (17-19).
- 동지연, 안지훈, 정유수, **오지용**, Jennifer G. Kim, "웨이포인트 기반 자동 로봇 궤적 생성을 위한 Wizard 튜토리얼의 설계 및 사용자 그룹 간 비교 연구", 제27회 전자정보통신 학술대회, 2025. 12. 11 (10-12).
- 최낙원, 이준구, **오지용**, "추종로봇을 위한 UWB-RGB 센서 융합 기반의사용자 위치 추정 방법", 제6회 한국 인공지능 학술대회, 2025. 9. 26 (24-27).
- 최낙원, 이준구, **오지용**, "추종로봇을 위한 UWB 기반의 사용자 위치 추정 방법 연구", 2025년도 한국통신학회 하계종합학술발표회, 2025. 6. 18 (18-21).
- 김진우, 이준구, **오지용**, "추종로봇을 위한 RGB 이미지 기반 사용자 위치추정", 제35회 통신정보 합동학술대회 (JCCI 2025), 2025. 4. 25 (23-25).
- **오지용**, 정유수, 이준구, "2D LiDAR 기반 사용자 추적 데이터셋 구축축", 제5회 한국 인공지능 학술대회, 2024. 9. 25.
- 이지은, **오지용**, "End-to-End 서빙로봇 위치추정의 불확실성 추정", 제5회 한국 인공지능 학술대회, 2024. 9. 25.
- **오지용**, 정유수, 이준구, "사용자 추적을 위한 2D LiDAR 데이터 어노테이션 방법", 2024년도 한국통신학회 하계종합학술발표회, 2024. 6. 19.
- 이준구, 이지은, 원혜민, **오지용**, "추종로봇을 위한 대상 추적 및 중심 추정 방법", 2024년도 한국통신학회 하계종합학술발표회, 2024. 6. 21.
- 이지은, **오지용**, 이학준, "트랜스포머 기반 카메라-라이다 융합 서빙로봇 위치재추정", 2024년도 한국통신학회 동계종합학술발표회, 2024. 1. 31.
- 이지은, 이준구, **오지용**, "사용자 추종로봇을 위한 종단간 선각속도 추정", 제4회 한국 인공지능 학술대회, 2023. 9. 21.
- **오지용**, 이지은, 이학준, "트랜스포머 기반 종단간 서빙로봇 위치추정", 영상처리 및 이해에 관한 워크샵 (IPIU) 2023. 2. 9.
