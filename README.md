...
- **오지용**, 정유수, 이준구, "2D LiDAR 기반 사용자 추적 데이터셋 구축축", 제5회 한국 인공지능 학술대회, 2024.
- 이지은, **오지용**, "End-to-End 서빙로봇 위치추정의 불확실성 추정", 제5회 한국 인공지능 학술대회, 2024.
- **오지용**, 정유수, 이준구, "사용자 추적을 위한 2D LiDAR 데이터 어노테이션 방법", 2024년도 한국통신학회 하계종합학술발표회, 2024.
- 이준구, 이지은, 원혜민, **오지용**, "추종로봇을 위한 대상 추적 및 중심 추정 방법", 2024년도 한국통신학회 하계종합학술발표회, 2024.
- 이지은, **오지용**, 이학준, "트랜스포머 기반 카메라-라이다 융합 서빙로봇 위치재추정", 2024년도 한국통신학회 동계종합학술발표회, 2024.
- 이지은, 이준구, **오지용**, "사용자 추종로봇을 위한 종단간 선각속도 추정", 제4회 한국 인공지능 학술대회, 2023.
- **오지용**, 이지은, 이학준, "트랜스포머 기반 종단간 서빙로봇 위치추정", 영상처리 및 이해에 관한 워크샵 (IPIU) 2023.
